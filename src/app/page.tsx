      ...
      <div className=" h-full flex flex-col lg:flex-row px-2 md:px-10 lg:px-12 xl:px-14 text-xl items-center justify-center content-center pt-10">
        ...
        <div className="h-full w-2/3 lg:w-1/2 flex flex-col gap-8">
          ...
          <p className="md:text-xl font-thin">
            ...
            expertise in web application development, machine learning, database
            management, and IT/security
          </p>
          <div className="flex gap-4 w-full">
            <Link
              className="text-sm md:text-lg text-center p-4 rounded-xl ring-2 ring-fuchsia hover:ring-purple hover:bg-purple font-semibold"
              href={"/projects"}
            >
              See my work
            </Link>
        ...
        <div className="relative h-1/2 w-2/3 lg:w-1/2 m-10 pt-8">
          <div className="absolute -inset-2 pt-8">
            <div className="w-100% h-full mx-0 opacity-40 blur-lg bg-purple"></div>
          </div>
