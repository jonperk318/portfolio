...
const PhotosPage = () => {
  ...
  return (
    ...
    >
      <div className="columns md:columns-2 lg:columns-3 relative z-10 gap-4 justify-center bg-black/[0.6] p-4 space-y-4">
