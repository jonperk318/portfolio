...
const ExperiencePage = () => {
    ...
    const experiences = [
        ...
        {title: "Software Developer (Intelligence Analyst II)", desc: "Built tools to increase data collection efficiency, automated retreival of 25+ TB of leaked data accross Linux VMs, wrote technical reports for Fortune 500 clients, created graphics in Python and Data Studio, analyzed leaked SQL databases", date: "Oct 2023 - Dec 2024", comp: "DarkTower"},
